...
$daemonRPC = new daemonRPC('18.132.124.81', 18081, true); // Change to match your daemon (monerod) IP address and port; 18081 is the default port for mainnet, 28081 for testnet, 38081 for stagenet
...
$walletRPC = new walletRPC('18.132.124.81', 18083, true); // Change to match your wallet (monero-wallet-rpc) IP address and port; 18083 is the customary port for mainnet, 28083 for testnet, 38083 for stagenet
